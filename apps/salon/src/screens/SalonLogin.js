...
import { loginWithEmail } from "salonq-shared/firebase";
  ...
  return (
    ...
    >
      <View style={s.inner}>
        ...
        <Text style={s.sub}>Salon Staff Portal</Text>

        <TextInput style={s.input} placeholder="Staff email" value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
...
const s = StyleSheet.create({
  ...
  input:     { backgroundColor: "#ffffff15", borderWidth: 1, borderColor: "#ffffff20", borderRadius: 12, padding: 14, fontSize: 15, color: "#fff", marginBottom: 12 },
